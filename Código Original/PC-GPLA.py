...
def relacion_dispersion(distribucion):
    ...
    global E_acumulador,E_wk_shift
...
vh = 8.                    # Velocidad maxima para la grafica de f(v)
pared_izquierda = 0.
pared_derecha = 1.
...
fig = plt.figure('Trayectoria_1particula')
ax = fig.gca(projection='3d')

x1 = x_aux[:,3000]
y1 = y_aux[:,3000]
z1 = sp.zeros(151)
ax.plot(x_aux[:,1000], y_aux[:,1000], z1)
ax.plot(x_aux[:,300], y_aux[:,300], z1)
ax.plot(x_aux[:,650], y_aux[:,650], z1)
