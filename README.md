...
Algoritmo PC-GPLA.py original, con la única adición de edición de tiempo de ejecución.

# Carpeta Código Optimizado Básico
Algoritmo ESMG1-GPLA.py básico, cuenta con las librerías básicas necesarias y suficientes para simular el plasma a una velocidad considerable. Incluye el archivo graficas.pyw que facilita la observación de las gráficas generadas al final del algoritmo.
